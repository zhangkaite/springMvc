...
public abstract class TextUtils {
	...
	private static JavaType map = MapType.construct(HashMap.class, SimpleType.construct(String.class), SimpleType
			.construct(String.class));

	private static JavaType embeddedMap = MapType.construct(HashMap.class, SimpleType.construct(String.class), MapType
			.construct(HashMap.class, SimpleType.construct(String.class), SimpleType.construct(String.class)));
